...
},init=function(experience){experienceTracking=experience;
...
var y=f(['<video id="',C,'" ','data-account="72451143001" ','data-player="',B.getPlayerId(),'" ','data-video-id="',B.getVideoId(),'" ','data-embed="default" ','data-setup=\'{"techOrder": ["hls", "html5", "flash"]}\' ','width="',B.getWidth(),'" ','height="',B.getHeight(),'" ','class="video-js" ',B.getAutoStart()?"autoplay ":"","controls>","</video>"].join(""));
z.empty();
z.append(y);
